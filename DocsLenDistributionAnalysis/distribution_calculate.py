...
if __name__ == "__main__":
    ...
    for file_name in file_names:
        ...
        evaluation_file = f"/data1/wangyan/BaselineFrameworkAnalysis/ExperimentResult/evaluation_result/main_different_noise-ration/VanillaRAG/main_noise-ration-{key}_VanillaRAG_{backbone}.json"

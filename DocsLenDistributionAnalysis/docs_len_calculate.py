...
if __name__ == "__main__":
    testbed_main_dir = "/data1/wangyan/BaselineFramework/testbed/main_different_noise-ration"
    dst_dir = "/data1/wangyan/DocsLenDistributionAnalysis/main_different_noise-ration_token-len"

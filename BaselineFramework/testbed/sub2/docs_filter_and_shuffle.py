...
if __name__ == "__main__":
    ...
    input_files = [f"origin/sub1_noise-type_{ration}.json" for ration in variables]
    output_files = [f"sub1_noise-type_{ration}.json" for ration in variables]
